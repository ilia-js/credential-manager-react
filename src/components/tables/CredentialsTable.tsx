...
export default function CredentialsTable() {
  const [credentials, setCredentials] = useState<CredentialPostItem[]>([]);
    ...
    return (
      <div>
        <i
          ...
          onClick={() =>
            copyToClipboard(item[CredentialsTableColumns.Password])
          }
        />
        <i
    ...
    <div className="app credentials-table">
      <div className="credentials-table__action-buttons">
        <Button
          ...
          label={lang.button.addCredential}
          icon="pi pi-plus"
          size="small"
          severity="success"
          outlined={true}
      ...
      <DataTable
        value={credentials}
        filterDisplay="row"
        sortField={CredentialsTableColumns.Type}
        sortOrder={1}
      >
        <Column
          field={CredentialsTableColumns.Type}
        ...
        />
        <Column
          field={CredentialsTableColumns.Username}
          header={lang.table.username}
          body={NameTemplate}
          filter
          sortable
        />
        <Column
          field={CredentialsTableColumns.Password}
          header={lang.table.password}
          body={Actions}
        />
      </DataTable>
      {isLoading && (
